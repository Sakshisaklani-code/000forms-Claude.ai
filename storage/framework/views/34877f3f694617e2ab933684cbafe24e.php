    ...
    <div class="auth-container">
        ...
        <div class="auth-card" style="text-align: center;">
            ...
            <p class="thank-you-message">
                ...
                <strong><?php echo e(session('email', 'your provided email address')); ?></strong>.
            </p>
                ...
                <div class="detail-card">
                    ...
                    <ul class="detail-list">
                        <li>
                            ...
                            <span class="detail-value"><?php echo e('FORM-' . strtoupper(uniqid())); ?></span>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <span class="detail-value"><?php echo e(ucfirst(session('category'))); ?></span>
                        </li>
                        <?php endif; ?>
                    </ul>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Git-folders\000FORMS-Claude.ai\000forms-Claude.ai\resources\views\pages\thank-you000forms.blade.php ENDPATH**/ ?>