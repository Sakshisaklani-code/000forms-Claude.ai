...
// Use withoutMiddleware to disable CSRF for this specific route
// Route::match(['get', 'post'], '/f/{slug}', [FormSubmissionController::class, 'submit'])
//     ->name('form.submit')
//     ->withoutMiddleware([\App\Http\Middleware\VerifyCsrfToken::class]);

Route::withoutMiddleware([\Illuminate\Foundation\Http\Middleware\VerifyCsrfToken::class])->group(function () {
    Route::match(['get', 'post'], '/f/{slug}', [FormSubmissionController::class, 'submit'])->name('form.submit');
...
Route::middleware('auth')->prefix('dashboard')->group(function () {
    ...
    // Submissions
    Route::get('/forms/{formId}/submissions/{submissionId}', [DashboardController::class, 'showSubmission'])->name('dashboard.submissions.show');
    Route::post('/dashboard/forms/{formId}/submissions/{submissionId}/download', [FormSubmissionController::class, 'downloadFile'])
    ->name('dashboard.submissions.download')
    ->middleware(['auth']);
    Route::delete('/forms/{formId}/submissions/{submissionId}', [DashboardController::class, 'destroySubmission'])->name('dashboard.submissions.destroy');
    Route::post('/forms/{formId}/submissions/{submissionId}/spam', [DashboardController::class, 'markAsSpam'])->name('dashboard.submissions.spam');
