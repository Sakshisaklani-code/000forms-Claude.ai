                                ...
                                <div style="margin-top: 24px; padding-top: 24px; border-top: 1px solid #1a1a1a;">
                                    ...
                                    <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                                        @foreach($submissionData as $key => $value)
                                            @if(!str_starts_with($key, '_') && $key !== 'email')
                                                <tr>
                    ...
                    <tr>
                        <td style="padding-top: 24px; text-align: center;">
                            <p style="margin: 0; color: #555555; font-size: 12px;">
                                This is an automated message from <a href="{{ config('app.url') }}" style="color: #00ff88; text-decoration: none;">000form.com</a>
                            </p>
                            @if($form->recipient_email)
                                <p style="margin: 8px 0 0; color: #333333; font-size: 11px;">
                                    Questions? Contact us at {{ $form->recipient_email }}
                                </p>
                            @endif
                        </td>
                    </tr>
